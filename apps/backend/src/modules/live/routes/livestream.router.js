...
import {
  ...
  liveIdParamSchema,
  pinProductSchema,
  addProductsToLiveSchema,
  liveHistoryQuerySchema,
  liveChartQuerySchema
} from '#validations/livestream.validation.js'
...
Router.post('/:liveId/start', grantAccess('update:own', 'LIVESTREAM'), validate(liveIdParamSchema), asyncHandler(livestreamController.startLive))
Router.post('/:liveId/join', grantAccess('read:any', 'LIVESTREAM'), validate(liveIdParamSchema), asyncHandler(livestreamController.joinLive))
Router.post('/:liveId/end', grantAccess('update:own', 'LIVESTREAM'), validate(liveIdParamSchema), asyncHandler(livestreamController.endLive))
...
Router.patch('/:liveId/unpin', grantAccess('update:own', 'LIVESTREAM'), validate(liveIdParamSchema), asyncHandler(livestreamController.unpinProduct))
...
Router.patch('/:liveId/cancel', grantAccess('update:own', 'LIVESTREAM'), validate(liveIdParamSchema), asyncHandler(livestreamController.cancelLiveSession))
