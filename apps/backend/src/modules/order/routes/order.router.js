...
import { checkoutSchema, orderByUserSchema, updateOrderStatusSchema, } from '#validations/order.validation.js'
...
Router.patch('/:orderId/cancel', grantAccess('update:own', 'ORDER'), asyncHandler(orderController.cancelOrder))
