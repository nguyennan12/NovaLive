...
**TODO còn lại:**
- ⚠️ VNPay/MoMo sau submit chưa redirect tới `response.paymentUrl`
- ⚠️ COD chưa có bước confirm lại đơn hàng (hiện submit thẳng)
- ⚠️ Sau đặt hàng thành công navigate về `/` tạm thời — cần trang `/orders/:orderId`
