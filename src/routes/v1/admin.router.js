...
Router.post('/category', asyncHandler(adminController.createCategory))
Router.post('/category/attribute', asyncHandler(adminController.addAttributeToCategory))

Router.post('/attribute', asyncHandler(adminController.createAttribute))
